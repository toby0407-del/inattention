...
import { LayoutDashboard, BarChart2, Settings, LogOut, ChevronDown, Code2, MessageCircle } from 'lucide-react';
...
const NAV_ITEMS = [
  ...
  { icon: MessageCircle, label: '與患者訊息', path: '/parent/messages' },
          ...
          {filteredNav.map(item => {
            ...
            return (
              ...
              >
                ...
                {item.path === '/parent/messages' && unreadCount > 0 && (
                  <span
                    className="rounded-full flex items-center justify-center text-white ml-auto"
                    style={{ fontSize: 10, fontWeight: 800, background: '#f43f5e', minWidth: 18, height: 18, padding: '0 4px' }}
                  >
                    {unreadCount}
                  </span>
                )}
